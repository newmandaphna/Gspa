...
export const classDateRange = (s: Pick<PublicClassSession, "startsAt" | "endsAt">) => `${dateFormat.format(new Date(s.startsAt))} to ${dateFormat.format(new Date(s.endsAt))} · America/New_York`;
